        ...
        <div className="flex gap-4 overflow-x-auto pb-4 -mx-4 px-4 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-5 scrollbar-none">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              {/* Product */}
              <div className="text-blue-600 text-xs font-semibold mb-3 bg-blue-50 px-3 py-1.5 rounded-lg inline-flex items-center gap-1.5 w-fit">
                <Bike className="w-3.5 h-3.5 shrink-0" aria-hidden />
                {t.product}
              </div>
