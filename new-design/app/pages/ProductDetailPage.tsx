...
import {
  ...
  Tag, MessageCircle, ArrowRight, Bike
} from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span className={`text-xs font-bold px-2.5 py-1 rounded-full ${product.inStock ? "bg-green-100 text-green-700" : "bg-red-100 text-red-600"}`}>
