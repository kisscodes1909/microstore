import { Bike, Facebook, Youtube, Instagram, MapPin, Phone, Mail, ArrowRight, ChevronDown } from "lucide-react";
    ...
    <footer className="bg-gray-950 text-gray-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-0 sm:gap-8">
          ...
          <div className="lg:col-span-2 pb-6 sm:pb-0 border-b border-gray-800 sm:border-0 mb-2 sm:mb-0">
            <Link to="/" className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                <div className="text-white font-black" style={{ fontSize: "1.1rem" }}>VeloShop</div>
                <div className="text-blue-500 text-xs">XE ĐẠP CHẤT LƯỢNG</div>
              </div>
            </Link>
            <p className="text-gray-500 text-sm leading-relaxed mb-4 max-w-xs">
              Cửa hàng xe đạp uy tín hàng đầu địa phương. Đại lý ủy quyền Giant, Trek, Specialized, Merida.
            </p>
            <div className="space-y-2 mb-4">
              <a href="tel:0901234567" className="flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-colors text-sm">
                <Phone className="w-3.5 h-3.5 text-blue-500 shrink-0" /> 0901 234 567
              </a>
              <a href="mailto:info@veloshop.vn" className="flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-colors text-sm">
                <Mail className="w-3.5 h-3.5 text-blue-500 shrink-0" /> info@veloshop.vn
              </a>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-center sm:text-left">
          <p className="text-gray-600 text-xs">© 2024 VeloShop. Tất cả quyền được bảo lưu.</p>
