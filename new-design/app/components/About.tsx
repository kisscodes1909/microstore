        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-2 sm:pb-6 lg:pb-0">
            ...
            <p className="text-gray-600 leading-relaxed mb-5 text-sm sm:text-base">
              VeloShop được thành lập từ năm 2014 với sứ mệnh mang đến những chiếc xe đạp chính hãng, chất lượng cao
              với mức giá cạnh tranh nhất. Chúng tôi là đại lý ủy quyền chính thức của Giant, Trek, Specialized và
              Merida tại khu vực.
            </p>
            ...
            <div className="grid grid-cols-4 gap-2 border border-blue-100 rounded-2xl overflow-hidden">
              {stats.map((s, i) => (
                ...
                >
                  <div
                    className="text-blue-700 font-black leading-none"
