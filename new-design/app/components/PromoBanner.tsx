      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="relative z-10 p-5 sm:p-8">
              <span className="inline-block bg-emerald-300 text-emerald-900 text-xs font-black px-3 py-1 rounded-full mb-3 uppercase tracking-wide">
                🔧 Dịch vụ
              </span>
              <h3 className="text-white font-black mb-1.5" style={{ fontSize: "clamp(1.1rem, 3vw, 1.5rem)" }}>
                Bảo dưỡng miễn phí
              </h3>
              <p className="text-emerald-200 text-sm mb-4">Khi mua xe tại VeloShop – áp dụng 1 lần</p>
              <span className="inline-flex items-center gap-1.5 text-white text-sm font-semibold group-hover:gap-3 transition-all">
