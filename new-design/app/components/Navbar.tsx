...
import { Menu, X, Bike, Phone, ChevronRight, Home, Package, Info, Wrench, Mail } from "lucide-react";
            ...
            <div className="flex items-center justify-between h-9 text-xs relative">
              <div className="flex items-center gap-5">
                <a href="tel:0901234567" className="flex items-center gap-1.5 hover:text-white transition-colors">
                  <Phone className="w-3 h-3" /> 0901 234 567
                </a>
                <span className="flex items-center gap-1.5">
                  🕐 T2–T7: 7:30–20:00 | CN: 8:00–18:00
                </span>
              </div>
          ...
          <div className="absolute top-0 right-0 bottom-0 w-[85vw] max-w-sm bg-white flex flex-col shadow-2xl">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <span className="font-black text-blue-700">VeloShop</span>
              </div>
              <button
                onClick={() => { setIsOpen(false); setShowCategories(false); }}
              ...
              {!showCategories ? (
                <>
                  ...
                  <div className="mx-5 mt-5 bg-blue-50 border border-blue-100 rounded-2xl p-4">
                    <div className="text-blue-800 font-bold text-sm mb-1">🎉 Ưu đãi hôm nay</div>
