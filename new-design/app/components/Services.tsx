import { Wrench, RefreshCw, Settings, Zap, Package, Users, ArrowRight } from "lucide-react";
        ...
        <div className="flex gap-3 overflow-x-auto pb-4 -mx-4 px-4 sm:hidden scrollbar-none mb-6">
          {services.map((s, i) => (
            ...
            >
              ...
              <span className="text-xs text-gray-400 font-medium bg-gray-50 px-3 py-1.5 rounded-full border border-gray-100 w-fit">
                ⏱ {s.time}
              </span>
            </div>
          ))}
